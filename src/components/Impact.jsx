...
export default function Impact() {
  ...
  return (
    <section id="impact" ref={ref}
      className="bg-ink text-white py-[140px] px-[52px]">
      <div className="max-w-[1140px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-[100px] items-start">

        {/* Left */}
        <div>
          <p className="reveal text-[11px] tracking-[0.28em] uppercase text-white/40 mb-7">
            Creating Impact
          </p>
          <h2 className="reveal delay-1 font-serif font-light leading-[1.2] text-white
                         text-[clamp(32px,3.5vw,52px)]">
            The impact<br />of <em className="italic">coaching</em>
          </h2>
        </div>
        ...
        <div>
          <p className="reveal font-serif text-2xl font-light italic leading-[1.55]
                        text-white/85 mb-11 pb-11 border-b border-white/10">
            While everyone's journey is different, the breakthroughs experienced
            with coaching can be <em>life changing</em>
          </p>

          <div className="flex flex-col gap-7">
            <p className="reveal delay-1 text-base font-extralight leading-[2.1] text-white/65">
            ...
            <p className="reveal delay-2 text-base font-extralight leading-[2.1] text-white/65">
            ...
            <p className="reveal delay-3 text-base font-extralight leading-[2.1] text-white/65">
              <strong className="text-white/90 font-normal block mb-2 text-[11px] tracking-[0.1em] uppercase">
            ...
            <p className="reveal delay-4 text-base font-extralight leading-[2.1] text-white/65">
              <strong className="text-white/90 font-normal block mb-2 text-[11px] tracking-[0.1em] uppercase">
                A clear impact
              </strong>
            ...
            <p className="reveal font-serif italic text-lg text-white/75 leading-[1.6]">
