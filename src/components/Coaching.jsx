...
const SCENARIOS = [
  ...
  'Looking to find a life partner?',
  'Is the life you want to lead feel out of reach?',
  'Is parenthood high jacking your own needs?',
  'Does your college-bound or post-college child desire direction?',
];
...
export default function Coaching() {
  ...
  return (
    <section id="coaching" ref={ref}
      className="bg-white py-[140px] px-[52px] md:px-[52px]">
      <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[100px] items-start">
        ...
        <div className="reveal-right md:order-last order-first">
          <div className="w-full aspect-[3/4] md:aspect-[3/4] overflow-hidden bg-paper2">
            <img src={clientImg} alt="Happy coaching client"
